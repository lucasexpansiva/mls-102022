/// <mls shortName="module" project="102022" enhancement="_100554_enhancementLit" folder="finance" />
export const moduleConfig = {
  "theme": "finance",
  "initialPage": "invoiceGeneratorPage",
  "menu": [
    {
      "pageName": "invoiceGeneratorPage",
      "title": "Invoice Generator Page",
      "auth": "admin",
